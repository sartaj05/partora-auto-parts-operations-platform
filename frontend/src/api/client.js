import { customers, demoAccounts, fitments, inventory, mockDashboard, modulesByRole, purchaseOrders, quotations, reorderSuggestions, salesFlow, stock, suppliers, warehouseState } from '../mock/data'
